      ...
      /*
        ...
        */
        ...
        function btn_minusculas(txt_may)
        {
            return txt.toLowerCase(txt_may)
        } // isEqual
        console.log(txt_may)
      /*
    ...
    */
   function calculateDogAge(edad_humano){
    let edad_humanoT= edad_humano*7;
    console.log(edad_humanoT)}
    ...
    let Pokemon1= new Pokemon('Pikachu','electrico','trueno','escudo electrico')
    let Pokemon2= new Pokemon('Bulbasaur','Planta','disparo venenoso','escudo de raíz')
